  ...
  return (
    <section className="w-[100vw] h-[100vh] flex justify-center items-center snap-center bg-banner bg-cover bg-center sm:h-[350px] sm:snap-align-none">
      ...
      >
        ...
        <button className="overflow-hidden relative w-[189px] font-light text-lg h-10 border border-customGreen text-white rounded-md cursor-pointer z-10 group sm:hidden">
          Подробнее
